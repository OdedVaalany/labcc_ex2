...
/**
 * @brief This function test if the given array equal
 * (by values) to the sorted arrays
 * @param start_sorted pointer to the head of the BusLine array after sorting
 * @param end_sorted pointer to the tail of the BusLine
 * array after sorting
 * @param start_original pointer to the head of the
 * BusLine array before sorting
