...
/**
 * @brief This function get a BusLine array and sort it by bubble
 * sort the duration fields
...
/**
 * @brief This function get a BusLine array and sort by quick sort
 * algo it by the duration fields
 * @param start pointer to the head of the BusLine array for soring
 * @param end pointer to the tail of the BusLine array for soring
 *
 */
